...
* kind = $RRTYPE#ServiceRequest "MedicationRequest" //kind of artifact as defined by http://hl7.org/fhir/request-resource-types ServiceRequest has been included as an example
