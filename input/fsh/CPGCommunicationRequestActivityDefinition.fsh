...
InstanceOf: http://hl7.org/fhir/uv/cpg/ActivityDefinition/cpg-communicationrequest-activitydefinition
Title: "[Human friendly ActivityDefinition name]"
Usage: #definition
* insert CPGKnowledgeExtensions
* insert CommonMetadata
* meta.profile[+] = "http://hl7.org/fhir/uv/cpg/ActivityDefinition/cpg-communicationrequest-activitydefinition"
...
* kind = $RRTYPE#CommunicationRequest "CommunicationRequest" //kind of artifact as defined by http://hl7.org/fhir/request-resource-types ServiceRequest has been included as an example
...
* dynamicValue[+].path = "code" // this is the CommunicationRequest.code element
