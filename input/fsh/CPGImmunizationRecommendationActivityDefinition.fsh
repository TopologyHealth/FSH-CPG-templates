...
InstanceOf: http://hl7.org/fhir/uv/cpg/ActivityDefinition/cpg-immunizationrecommendation-activitydefinition
Title: "%Human friendly ActivityDefinition name%"
Usage: #definition
* insert CPGKnowledgeExtensions
* insert CommonMetadata
* meta.profile[+] = "http://hl7.org/fhir/uv/cpg/ActivityDefinition/cpg-immunizationrecommendation-activitydefinition"
...
* kind = $RRTYPE#ImmunizationRecommendation "ImmunizationRecommendation" //kind of artifact as defined by http://hl7.org/fhir/request-resource-types ServiceRequest has been included as an example
